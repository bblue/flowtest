...
master: [![Build Status](https://travis-ci.org/bblue/ruby.svg?branch=master)](https://travis-ci.org/bblue/ruby)
develop: [![Build Status](https://travis-ci.org/bblue/ruby.svg?branch=develop)](https://travis-ci.org/bblue/ruby)
