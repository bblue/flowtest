 ...
 * @todo friends, followers og slikt m� ikke v�re tilgjengelig hos en guest eller crawler. Flytte disse til Member
 * @todo vurdere om jeg skal lage en admin user
 **/
abstract class User extends Entity
{
    use UsergroupUserAssociationTrait;//@todo Tror ikke jeg har noen effekt ut av � bruke traits her
     ...
     * @var User
     * @todo Dette skal v�re one-to-many
     */
    private $sponsor;
    ...
    {
        //@todo: dette skal sannsynligvis v�re et repository med entities, slik at jeg m� kalle ->count() p� de som kaller metoden
        return 0;
    }
