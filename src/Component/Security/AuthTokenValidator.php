...
final class AuthTokenValidator implements iAuthTokenChecker, iValidationBasics
{
    ...
    public function validate() //@todo: Disse skal trigge error, ikke exceptions
    {
        ...
        // Check if token IP matches current IP @todo: Det m� v�re murlig � skru av denne sjekken, eventuelt tillatte noe endring 
        ...
        $this->_validated = true; //@todo finne ut hvorfor jeg egentlig har denne. tror det er et sp�kelse
